...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_CJH(
    ...
    KC_LALT, KC_LGUI, KC_LCTL,                   KC_SPC,           KC_SPC,           __,      F(0),    KC_RALT, KC_APP,  KC_RCTL
  ),
  /* 1: fn */
  LAYOUT_CJH(
    ...
    _______, __     , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_UNDS, KC_MINS, KC_EQL , _______, _______, __     , KC_PGUP,
    KC_CAPS, KC_INS , _______,                   _______,          _______,          __     , _______, KC_HOME, KC_END , KC_PGDN
  ),
};
